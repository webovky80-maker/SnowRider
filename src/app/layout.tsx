...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning className={plusJakartaSans.variable}>
      ...
      <body className={`${plusJakartaSans.className} font-sans min-h-screen flex flex-col bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 antialiased selection:bg-green-500 selection:text-white transition-colors duration-200`}>
        <ThemeProvider>
          <Header />
