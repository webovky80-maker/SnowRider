...
export default function HomePage() {
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      {/* Game Player Canvas */}
      <section id="game-player" aria-label="Game Canvas" className="w-full">
        <GamePlayer />
      </section>

      {/* Tabbed Guide, Controls, Sleds & FAQ */}
      <section id="game-tabs" aria-label="Game Guide and Sleds" className="w-full">
        <GameTabs />
      </section>

      {/* In-Depth SEO Guide (Clean, authoritative, human-written tone) */}
      <article aria-label="Snow Rider 3D Overview" className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-6 sm:p-8 shadow-xs space-y-6 text-gray-700 dark:text-gray-300 leading-relaxed text-sm sm:text-base">
        <div>
