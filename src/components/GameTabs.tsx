          ...
          return (
            <button
              ...
              className={`flex-1 min-w-[90px] py-2 px-3 rounded-md text-sm font-medium transition-all text-center ${
                isActive
                  ? 'bg-blue-50 dark:bg-blue-950/50 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800/80 font-bold shadow-xs'
                  : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700/50 border border-transparent'
              }`}
            >
              {tab.label}
            </button>
