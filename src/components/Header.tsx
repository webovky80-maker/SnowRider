              ...
              return (
                <Link
                  ...
                  className={`flex items-center px-3.5 py-2 text-sm font-medium rounded-md transition-colors ${
                    isActive
                      ? 'text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-950/40 font-semibold'
          ...
          <div className="hidden md:flex items-center gap-3">
            <div className="relative w-56">
              <input
                ...
                placeholder="Search..."
                className="w-full h-9 pl-9 pr-3 rounded-md bg-gray-100 dark:bg-gray-800 border border-transparent focus:border-gray-300 dark:focus:border-gray-700 text-sm text-gray-900 dark:text-gray-200 placeholder-gray-400 focus:outline-hidden focus:bg-white dark:focus:bg-gray-900 transition-colors"
              />
